...
app.model({ namespace: 'auditLog', ...(require('/Users/zhangsongyun/abp_antd/src/pages/Administration/models/auditLog.js').default) });
app.model({ namespace: 'role', ...(require('/Users/zhangsongyun/abp_antd/src/pages/Administration/models/role.js').default) });
